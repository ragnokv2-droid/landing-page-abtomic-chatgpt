    ...
    <main>
      ...
      <section className="hero shell">
        <div className="heroCopy">
          ...
          <div className="heroQuickTrust"><span><Truck size={15}/> Frete grátis para todo Brasil</span><span><LockKeyhole size={15}/> Pagamento seguro</span></div>
      ...
      <section className="reviews shell">
        <div className="sectionCenter">
          ...
          <p className="reviewNote">Fotos enviadas por clientes</p>
        </div>
      ...
      <section className="faq shell">
        ...
        <div className="faqList">
          {[
            ...
            ['Qual é o prazo de envio?', 'O prazo de entrega é informado no processo de compra conforme o endereço de destino.'],
            ['Vou receber código de rastreio?', 'Sim. Após o processamento do pedido, o código de rastreio é disponibilizado para acompanhamento da entrega.'],
            ['O que vem na embalagem?', 'Você recebe o aparelho AB Tomic conforme apresentado nesta página, com seus componentes originais.'],
